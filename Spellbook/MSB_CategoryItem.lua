...
class "CCategoryItem"
{
	__init = function(self, parent)
		...
		self.lightBorder:SetTexture("Interface\\AddOns\\TeronModernSpellBook\\Assets\\Spellbook\\spellbook-section-highlight")
		...
		self.separator:SetTexture("Interface\\AddOns\\TeronModernSpellBook\\Assets\\Spellbook\\separator")
	end;
